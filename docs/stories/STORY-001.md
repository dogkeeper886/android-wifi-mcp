...
- Notes: the device-browser legs require Chrome Canary foregrounded (precondition); shared-device concurrent-writes (TS-07 TC-02) left defined-by-serialization, not stress-tested (relates to #62).
